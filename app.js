...
.pauseFor(1800)
.changeDelay(20)
.typeString('Salut ! Moi c\'est Stacey')
.pauseFor(300)
.typeString('<strong>, Développeur Web</strong> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #647687;"> CSS</span> !')
.pauseFor(1000)
.deleteChars(5)
.typeString('<span style="color: #bc8f8f;"> Django</span> !')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: #8b4513;"> React</span> !')
.pauseFor(1000)
.deleteChars(8)
.typeString('<span style="color: #b22222;"> JavaScript</span> !')
.start()
